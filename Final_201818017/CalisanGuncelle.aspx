<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalisanGuncelle.aspx.cs" Inherits="Final_201818017.CalisanGuncelle" %>
...
&nbsp;&nbsp;
            <asp:TextBox ID="TCKN" runat="server"></asp:TextBox>
            &nbsp;
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" controltovalidate="TCKN" runat="server" ValidationExpression="[0-9]{11}" ErrorMessage="Lütfen 11 haneli TC numaranızı giriniz."></asp:RegularExpressionValidator>
            <br />
            <br />
...
&nbsp;&nbsp;
            ...
            <br />
            <br />
            <asp:Button ID="kayitguncelle" runat="server" Height="30px" Text="Kaydı Güncelle" Width="120px" OnClick="kayitguncelle_Click" />

            <br />
            <br />
            <asp:Button ID="kayitsil" runat="server" Height="30px" Text="Kaydı Sil" Width="120px" OnClick="kayitsil_Click" />
            <br />
            <br />
       </div>
    </form>
